    ...
    <BackgroundBlock variant="lightBG">
      <Container>
        <div className="flex pb-12 lg:pb-[64px]">
          <span className="w-[90px] md:w-[176px] lg:w-1/2 break-words  text-[#16363D] text-[10px] md:text-[14px] lg:text-[18px] tracking-[.02em] leading-[100%] font-semibold !font-Archivo uppercase">
            {data?.LeftText}
          </span>
